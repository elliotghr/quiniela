                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 align-items-center">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle me-2 active d-flex gap-1 align-items-center" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <svg xmlns="http://www.w3.org/2000/svg" data-dark="dark-icon" width="16" height="16" fill="currentColor" class="bi bi-moon-stars" viewBox="0 0 16 16">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" data-dark="light-icon" width="16" height="16" fill="currentColor" class="bi bi-brightness-high-fill" viewBox="0 0 16 16">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="<?= $menu['modulo_id'] ?>">
                            <li>
                                <a class="dropdown-item active" href="#" data-dark-option="dark-icon">
                            ...
                            <li>
                                <a class="dropdown-item" href="#" data-dark-option="light-icon">
