<div class="shadow bg-white p-4 mb-4 mt-4 rounded-3">
    ...
    <div class="form-floating mb-3 text-center">
        ...
        <div class="alert alert-info text-start" role="alert">
            <i class="fas fa-exclamation-circle"></i> Ingresa a Quinieland para comenzar a llenar tu quiniela.
        </div>
    </div>

    <div class="d-grid gap-2 justify-content-md-end d-md-flex">
        <a href="<?=base_url()?>" class="btn btn-alternative" role="button"><i class="fas fa-link"></i> Ir a Quinieland</a>
    </div>
</div>